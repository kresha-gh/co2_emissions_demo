...
**EDIT: There were no "k"'s in my dataset.**

We can remove the "k" and multiply those values by 1000 with the following code:

**EDIT: Since there's no k's in my data, the last code section gives out an error message, which is why I removed it.**
...
selected_countries = ["China", "USA", "India", "Germany", "Switzerland"]
...
fig_chart = px.line(
    ...
    y="emissions",
    color="country",
    title="CO₂ Emissions for Selected Countries (1990–2022)",
)
